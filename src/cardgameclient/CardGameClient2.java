...
//            }
//            if (inLine.equalsIgnoreCase("rec-easy")) {
//                temp = "{\"action\": \"reconnect-game\", \"type\" : \"easy\"}";
//            }
//            if (inLine.equalsIgnoreCase("rec")) {
//                temp = "{\"action\": \"reconnect-game\", \"type\" : \"def\"}";
//            }
//            if (inLine.equalsIgnoreCase("rec-ok")) {
//                temp = "{\"action\": \"reconnect-done\"}";
//            }
//            
